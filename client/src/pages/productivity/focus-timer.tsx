...
export default function FocusTimer() {
  ...
  return (
    <ToolLayout title="Focus Timer" description="Pomodoro timer for focused work">
          ...
          {showSettings ? (
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <Slider
                  ...
                  step={1}
                />
                <p className="text-sm text-muted-foreground text-center">{settings.workDuration} minutes</p>
              </div>
            ...
            <>
              ...
              <div className="text-center space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Total time focused: {formatTotalTime(totalTimeWorked)}
                </p>
              </div>
            </>
          )}
